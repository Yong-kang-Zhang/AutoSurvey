...
def paras_args():
    ...
    parser.add_argument('--rag_num', default=24, type=int, help='Number of references passed to each subsection writer')
    parser.add_argument('--keyword_num', default=10, type=int, help='Number of keywords for topic decomposition')
    parser.add_argument('--candidate_per_keyword', default=36, type=int, help='Number of candidates retrieved per keyword')
